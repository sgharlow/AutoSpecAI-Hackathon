...
export const API_CONFIG = {
  BASE_URL: window.AUTOSPEC_API_URL || 'YOUR_API_GATEWAY_URL',
  VERSION: 'v1',
  TIMEOUT: 30000,
  
  // API Keys - Should be configured via environment or injected at build time
  API_KEYS: [
    window.AUTOSPEC_API_KEY || 'YOUR_API_KEY_HERE'
  ],
  
  DEFAULT_API_KEY: window.AUTOSPEC_API_KEY || 'YOUR_API_KEY_HERE'
};
